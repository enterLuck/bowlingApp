...
function PinClass(pArray){
	this.PinClass = pArray;
		pins.pin1=pArray[0];
		pins.pin2=pArray[1];
		pins.pin3=pArray[2];
		pins.pin4=pArray[3];
	...
	this.getPinTotal = function(){
		var total = pins.pin1+pins.pin2+pins.pin3+pins.pin4+pins.pin5+pins.pin6+pins.pin7+pins.pin8+pins.pin9;
		return total; 
	};
};
